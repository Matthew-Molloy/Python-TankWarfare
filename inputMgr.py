...
class InputMgr(ogre.FrameListener):
    ...
    def frameStarted(self, frameEvent):
        ...
        if currMouse.buttonDown(OIS.MB_Left):
            ...
            r = mouseRay.intersects(self.engine.gfxMgr.plane)
            point = mouseRay.getPoint(r.second)
            print point

            if self.engine.overlayMgr.showMenu == True and self.engine.selectionMgr.startCheck(point):
