...
class WidgetMgr:
    ...
    def init(self):
        ...
        self.text.setPosition(0.04, 0.83)
        ...
        self.text = self.overlayManager.createOverlayElement("TextArea", "Tank 0 Cannon")
        self.text.setPosition(0.04, 0.87)
        self.text.setDimensions(1, 1)
        self.text.setCaption("Tank 0 Cannon: Ready")
        self.text.setCharHeight(.025)
        self.text.setFontName("StarWars")
        self.text.setColour(( 1, 1, 1 ))
        self.text.setSpaceWidth(.01)
        ...
        self.text = self.overlayManager.createOverlayElement("TextArea", "Tank 0 Missile")
        self.text.setPosition(0.04, 0.91)
        self.text.setDimensions(1, 1)
        self.text.setCaption("Tank 0 Missile: Ready")
        self.text.setCharHeight(.025)
        self.text.setFontName("StarWars")
        self.text.setColour(( 1, 1, 1 ))
        self.text.setSpaceWidth(.01)
        ...
        self.text.setPosition(0.78, 0.83)
        self.text.setDimensions(1, 1)
        ...
        self.text = self.overlayManager.createOverlayElement("TextArea", "Tank 1 Cannon")
        self.text.setPosition(0.78, 0.87)
        self.text.setDimensions(1, 1)
        self.text.setCaption("Tank 1 Cannon: Ready")
        self.text.setCharHeight(.025)
        self.text.setFontName("StarWars")
        self.text.setColour(( 1, 1, 1 ))
        self.text.setSpaceWidth(.01)
        ...
        self.text = self.overlayManager.createOverlayElement("TextArea", "Tank 1 Missile")
        self.text.setPosition(0.78, 0.91)
        self.text.setDimensions(1, 1)
        self.text.setCaption("Tank 1 Missile: Ready")
        self.text.setCharHeight(.025)
        self.text.setFontName("StarWars")
        self.text.setColour(( 1, 1, 1 ))
        self.text.setSpaceWidth(.01)
